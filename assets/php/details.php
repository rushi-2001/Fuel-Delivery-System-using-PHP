    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Fuel</a>
            </li>
                <li class="no-padding">
...
<div>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
        ...
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Rushi, Jay, Sanidhya</a></span>
      </div>
    </div>
  </footer>
    <!-- END FOOTER -->
